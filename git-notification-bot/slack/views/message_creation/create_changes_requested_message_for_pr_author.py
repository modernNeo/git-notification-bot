...
def create_changes_requested_message_for_pr_author(author_atlassian_id: str,
                                                   atlassian_id_for_person_who_requested_changes: str, pr_title: str,
        ...
        "blocks": [{
            ...
            "text": {
                ...
                "text": f"Hi <@{author_slack_id}>,\n\n"
                        f"<@{get_slack_id_by_atlassian_account_id(atlassian_id_for_person_who_requested_changes)}> "
                        f"request changes on your PR <{pr_link}|{pr_title}>"
            },
            "accessory": {
                "type": "button",
                "text": {
